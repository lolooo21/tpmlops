...
class PredictionService:
    ...
    def __init__(self, model: TaxiTripDurationModel, repository):
        self._model = model
    ...
    def predict(self, payload: dict) -> tuple[int, int]:
        ...
        prediction_id = self._repository.save_prediction(payload, prediction)
...
def load_prediction_service() -> PredictionService:
    ...
    return PredictionService(model, build_prediction_repository())
